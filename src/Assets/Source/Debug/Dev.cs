		...
		if (showMenu)
		{
			...
			if (showNotifications)
			{
				...
				if (Button(rect, "ScheduleLocalNotification Repeat"))
				{
					...
					ln.repeatInterval = CalendarUnit.Minute;
				...
				rect.y += sy;
				if (Button(rect, "localNotificationCount: " + NotificationServices.localNotificationCount))
				{
					NotificationServices.ClearLocalNotifications();
				}
				rect.y += sy;
				if (Button(rect, "scheduledLocalNotifications: " + NotificationServices.scheduledLocalNotifications.Length))
				{
			...
			else if (showDeviceInfo)
			{
				...
				rect.y += sy;
#if UNITY_IPHONE
				Button(rect, "iPhone.generation: " + iPhone.generation);
				rect.y += sy;
				Button(rect, "iPhone.vendorIdentifier: " + iPhone.vendorIdentifier);
				rect.y += sy;
#endif
